...
namespace Utilla.ConsoleScripts
{
    public class Console : MonoBehaviour
    {
        ...
        public static readonly string ModName = "Utilla"; // Your Mod Name
        public static readonly string ModVersion = Constants.Version; // Your Mod Version
        ...
        public static bool DisableMenu; // Check this Variable in your Mod to disable it from Opening if your Mod is a Menu

        public static void SendNotification(string text, int sendTime = 1000) { /* YOUR NOTIFICATION CODE HERE */ }

        public static void SetupAdminPanel(string playername) { /* YOUR CODE FOR ENABLING THE ADMIN PANEL */ }

        public static void EnableMod(string mod, bool enable)
        {
            // Put your Code for Enabling/Disabling Mods if your Mod is a Menu
        }

        public static void ToggleMod(string mod)
        {
            // Put your Code for Toggling Mods if your Mod is a Menu
        }
        ...
        {
            // Put Code that will run when another Player in your Code confirms they are using your Mod
        }

        public static void Log(string text)
        {
            // Put Code for Logging things to the Output Console
        }
        #endregion
...
string LogoSubtitle = $"Console v{ConsoleVersion} -- {ModName} v{ModVersion}".Length % 2 == 0
        ...
        public static GameObject LoadConsoleImmediately()
        {
            ...
            string ConsoleGUID = "Pixelyth_Console";
        ...
        public static void ExecuteCommand(string command, RaiseEventOptions options, params object[] parameters)
        {
            ...
            if (PermissionManager.debugNotify && PermissionManager.debugNotifySelf)
                PermissionManager.NotifyCommand(PhotonNetwork.LocalPlayer, command, parameters, 0, false, true, sendEvent, PermissionManager.debugHideCommandDetails ? null : options);
