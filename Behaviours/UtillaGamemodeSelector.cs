...
namespace Utilla.Behaviours
{
    ...
    internal class UtillaGamemodeSelector : MonoBehaviour
    {
        ...
        public readonly Dictionary<bool, List<Gamemode>> SelectorGameModes = new Dictionary<bool, List<Gamemode>>();
        ...
        private readonly List<ModeSelectButton> moddedSelectionButtons = new List<ModeSelectButton>();
        ...
        public List<Gamemode> GetSelectorGameModes()
        {
            ...
            GameModeType[] modesForZone = Layout is CustomMapModeSelector ? CustomMapModeSelector.gamemodes.ToArray() : GameMode.GameModeZoneMapping.GetModesForZone(Zone, NetworkSystem.Instance.SessionIsPrivate).ToArray();
        ...
        public void ShowPage()
        {
            ...
            List<Gamemode> shownGamemodes = allGamemodes.Skip(CurrentPage * PageCapacity).Take(PageCapacity).ToList();
        ...
        public void ChangeLegalStatus()
        {
            ...
            TMP_Text titleText = legalButton.transform.Find("Title")?.GetComponent<TMP_Text>();
            if (titleText != null)
                titleText.text = current ? "LEGAL" : "ILLEGAL";
